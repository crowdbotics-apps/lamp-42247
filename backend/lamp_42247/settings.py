"""
Django settings for lamp_42247 project.
...
WSGI_APPLICATION = 'lamp_42247.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lamp_42247 API",
    "DESCRIPTION": "API documentation for lamp_42247 App",
    "VERSION": "v1",
}
